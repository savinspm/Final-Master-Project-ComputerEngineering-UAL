...
\definecolor{ocre}{RGB}{69,107,159} % Define the main color used for highlighting throughout the book
...
\usepackage[utf8]{inputenc} % To use acent word
...
\newcommand{\nombreTFM}{\sffamily\normalsize\bfseries Nombre del TFM}
